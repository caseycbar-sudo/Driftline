...
export default async function AccountPage() {
  ...
  return <main className="account-page">
    ...
    <section className="account-content">
      ...
      <div className="quick-cards"><Link href="/cookbook"><span>01</span><h3>Choose your meals</h3><p>Browse 41 meal prep recipes and pick the dishes your household will love.</p><b>Open cookbook →</b></Link><Link href="/cookbook?add=recipe"><span>02</span><h3>Add your own recipe</h3><p>Share a family favorite or a recipe you already know you love.</p><b>Add a personal recipe →</b></Link><a href="/meal-prep#booking"><span>03</span><h3>Request a visit</h3><p>Once your starter menu feels right, check North Coast availability.</p><b>Check availability →</b></a></div>
