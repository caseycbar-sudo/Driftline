...
export default function Disclosures(){return <main className="legal-page"><SiteHeader/><header><span>Disclosure version {DISCLOSURE_VERSION}</span></header><section><p>IMPORTANT SERVICE INFORMATION</p><h1>Clear expectations protect everyone.</h1><div className="legal-note"><b>Attorney-review draft</b><span>These operational disclosures are designed around Driftline’s current Oregon in-home personal-chef model. Oregon counsel and the appropriate local regulator should review them before public launch.</span></div><LegalGroup title="Customer service disclosures" items={customerSections}/><LegalGroup title="Chef workplace acknowledgments" items={chefSections}/><footer><p>Questions or incident reports: <a href="mailto:hello@driftlineprovisions.com">hello@driftlineprovisions.com</a></p><Link href="/">Return home →</Link></footer></section><SiteFooter/></main>}
