...
export default function StartPage(){return <main className="start-page">
  ...
  <section className="start-choices">
    ...
    <a className="start-prep" href="/meal-prep#pricing"><div><small>EVERYDAY SUPPORT</small><h2>In-Home Meal Prep</h2><p>A trusted local chef shops, cooks, portions, labels, and cleans up—leaving your refrigerator ready for an easier week.</p><ul><li>6–24 portions per visit</li><li>30 meal prep recipes plus family favorites</li><li>Meals ready · kitchen clean</li></ul><b>Explore weekly meal prep <span>→</span></b></div></a>
  </section>
