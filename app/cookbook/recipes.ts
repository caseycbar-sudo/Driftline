...
export const recipes: Recipe[] = [
  ...
  {
    "id": 13,
    "slug": "pork-chile-verde-over-rice",
    "side": "meal-prep",
    "title": "Pork Chile Verde over Rice",
    "category": "Beef, Pork & Lamb",
    "description": "Pork shoulder braised low and slow in a charred tomatillo, poblano and jalapeño salsa until it falls apart, finished with lime and cilantro, over fluffy garlic rice.",
    "servings": 12,
    "yieldNote": "12 portions (about 1¼ cups chile verde and ¾ cup rice each)",
    "active": 50,
    "total": 210,
    "tags": [
      "High protein",
    ...
    "ingredients": [
      "7 lb boneless pork shoulder (pork butt), hard fat cap trimmed, cut into 1½-inch cubes",
      "2 tbsp kosher salt (for the pork)",
      "3 tbsp neutral oil",
      "3 lb tomatillos, husked and rinsed",
      "4 poblano peppers",
      "3 jalapeños (seed some or all for less heat)",
      "1 large yellow onion, quartered (for broiling)",
      ...
      "4 cups long-grain white rice, rinsed (for the rice)",
      "2 tbsp neutral oil (for the rice)",
      "1 small onion, finely chopped (for the rice)",
      "2 cloves garlic, minced (for the rice)",
      "6 cups water or chicken broth (for the rice)",
      "2 tsp kosher salt (for the rice)"
    ],
    "directions": [
      "Toss the pork with the salt. You can do this up to a day ahead and refrigerate it.",
      "Heat the broiler. Spread the tomatillos, poblanos, jalapeños, quartered onion and garlic on foil-lined sheet pans and broil about 6 inches from the heat for 8 to 12 minutes, turning once, until charred in spots and the tomatillos slump. Cover the poblanos and jalapeños in a bowl for 10 minutes, then peel, stem and seed the poblanos (and the jalapeños if you want it milder).",
      "Blend the tomatillos with their juices, the peppers, broiled onion and garlic, half the cilantro and 1 cup of the broth until mostly smooth.",
      "Heat the oil in a 7-quart or larger Dutch oven over medium-high heat. Brown the pork in 3 or 4 batches without crowding, 6 to 8 minutes per batch, and move it to a bowl.",
      "Lower the heat to medium, add the chopped onion and cook 5 minutes, scraping up the browned bits. Stir in the cumin and oregano for 30 seconds.",
      "Return the pork and its juices, then add the salsa and the remaining 3 cups broth. Bring to a simmer, cover and cook on low (or in a 325°F oven) for 2 to 2½ hours, stirring now and then, until the pork is fork-tender. It will be cooked well past 145°F, with no pink.",
      "Uncover and simmer 10 to 15 minutes if needed to thicken it to a stew. Stir in the lime juice and the rest of the cilantro, chopped, and season with salt.",
      "For the rice, heat the oil in a large pot over medium heat, cook the onion 3 minutes and the garlic 30 seconds, then stir in the rice for 2 minutes. Add the water and salt, bring to a boil, cover and cook on low 18 minutes. Rest 10 minutes off the heat, fluff and spread on a sheet pan to cool.",
      "Divide the chile verde among shallow pans no more than 2 inches deep and cool uncovered until it drops to 70°F, within 2 hours. Skim the fat off the top if you like.",
      "Pack ¾ cup rice on one side and about 1¼ cups chile verde on the other in each of 12 leak-proof containers, so the rice doesn't soak up all the sauce."
    ],
    "equipment": [
      "7-quart or larger Dutch oven",
      "Rimmed sheet pans",
      "Blender",
      "Large pot with lid",
    ...
    "storage": "Cool uncovered in shallow layers so everything drops to 70°F within 2 hours and to 41°F or below within the next 4 hours, then lid and refrigerate at 40°F or colder. Keeps 4 days. Freezes up to 3 months; freeze the chile verde apart from the rice for the best texture.",
    "reheating": "Microwave: vent the lid and heat 3 to 4 minutes, stirring halfway, until it reaches 165°F. Stovetop: warm in a covered saucepan over medium with a splash of water for 8 to 10 minutes.",
    "makeAhead": "",
    "safety": "Braised shoulder goes far past pork's 145°F safe minimum; cook until fork-tender with no pink. Cool large batches in shallow pans, never in the pot. Reheat to 165°F.",
  ...
  },
  {
    ...
    "ingredients": [
      ...
      "8 cloves garlic, minced",
      "2 jalapeños or serranos, slit lengthwise",
      "1 tbsp ground coriander",
      ...
      "4 cups basmati rice (for the rice)",
      "6 cups water (for the rice)",
      "2 tsp kosher salt (for the rice)",
    ...
    "equipment": [
      "Wide 7-quart Dutch oven or braiser",
      "Medium pot with lid",
      "Rimmed sheet pan",
      "Shallow pans for cooling",
      "Instant-read thermometer",
  ...
  {
    "id": 31,
    "slug": "herb-roasted-chicken-thighs-with-broccoli-and-red-peppers",
    "side": "meal-prep",
    "title": "Herb-Roasted Chicken Thighs with Broccoli and Red Peppers",
    "category": "Poultry",
    "description": "Bone-in, skin-on chicken thighs under a paprika, garlic and dried-herb rub, roasted until the skin crisps, packed with tender broccoli and sweet roasted red pepper strips.",
    "servings": 12,
    "yieldNote": "12 portions (2 thighs, about 1¼ cups broccoli and ½ cup peppers each)",
    "active": 35,
    "total": 85,
    "tags": [
      "High protein",
    ...
    "image": "/cookbook/mp/herb-roasted-chicken-thighs-with-broccoli-and-red-peppers.webp",
    "photoCredit": {
      "author": "MealPro",
      "source": "Unsplash",
      "page": "https://unsplash.com/photos/a-close-up-of-a-plate-of-food-with-broccoli-MJaF6pVNEfk"
    },
    "ingredients": [
      "24 bone-in, skin-on chicken thighs (about 8 lb)",
      "¼ cup olive oil (for the chicken)",
      "2 tbsp kosher salt (for the chicken)",
      "2 tbsp sweet paprika",
      "1 tbsp smoked paprika",
      ...
      "6 large red bell peppers, cut into ½-inch strips",
      "2 tbsp olive oil (for the peppers)",
      "½ tsp kosher salt (for the peppers)",
      "5 lb broccoli crowns, cut into bite-size florets (or 4 lb pre-cut florets)",
      "1 tsp kosher salt (for the broccoli)"
    ],
    "directions": [
      "Heat the oven to 425°F with racks in the upper-middle and lower-middle positions. Line two rimmed sheet pans with foil and set a wire rack in each.",
      "Stir the chicken salt, both paprikas, garlic powder, onion powder, parsley, oregano, thyme, pepper and cayenne together in a bowl.",
      "Pat the thighs very dry and trim any skin hanging past the meat. Rub them with the olive oil, then sprinkle the spice mix all over, working some under the loose skin. Use a spoon for the rub so your hands never go back into the bowl. Set the thighs skin side up on the racks, not touching. (For extra-crisp skin, season them up to 24 hours ahead and refrigerate uncovered.)",
      "Roast 35 to 45 minutes, rotating the pans halfway, until the skin is deep golden and the thickest part reads 175°F to 185°F near, but not touching, the bone. Move the thighs to a clean rack to rest.",
      "Toss the pepper strips with the olive oil and salt, spread them on a clean sheet pan and roast at 425°F for 15 to 18 minutes, until softened and lightly charred at the edges but still holding their shape.",
      "While the peppers roast, bring 1 inch of water to a boil under a steamer basket. Steam the broccoli in two batches for 3 to 4 minutes, until bright green and just tender-crisp, then spread it on a sheet pan, sprinkle with the salt and let the steam escape. Leave it slightly firm; it softens more when reheated.",
      "Cool the chicken, peppers and broccoli uncovered in single layers until they drop to 70°F, within 2 hours.",
      "Pack 2 thighs, about 1¼ cups broccoli and ½ cup peppers into each of 12 containers. Keep the thighs skin side up and resting on the container floor, not on the broccoli, so the skin doesn't steam soft."
    ],
    "equipment": [
      "3 rimmed sheet pans",
      "2 wire racks",
    ...
    "storage": "Cool uncovered in shallow layers so everything drops to 70°F within 2 hours and to 41°F or below within the next 4 hours, then lid and refrigerate at 40°F or colder. Keeps 4 days. The chicken freezes well for up to 3 months, but broccoli turns soft after freezing, so freeze only if the customer asks.",
    "reheating": "Microwave: vent the lid and heat at 70% power for 2½ to 3½ minutes, until the chicken reaches 165°F. For crisp skin: move the thighs to a pan and heat in a 375°F oven or air fryer for 12 to 15 minutes, adding the vegetables for the last 5.",
    "makeAhead": "",
    "safety": "Chicken is safe at 165°F; this recipe takes the thighs further so the connective tissue melts and they stay juicy after reheating. Throw out any spice rub left in a bowl that touched raw chicken. Reheat to 165°F.",
    "chefNotes": "Thighs are the forgiving cut for meal prep: they stay juicy through a microwave where breasts dry out, and the family packs at Costco and Fred Meyer are among the cheapest proteins in the store. Salt amounts assume Diamond Crystal kosher salt; with Morton, use a little over half."
  },
  {
    "id": 32,
    "slug": "chicken-and-potato-curry",
    "side": "meal-prep",
    "title": "Chicken and Potato Curry",
    "category": "Poultry",
    "description": "Bone-in chicken simmered with big chunks of potato in a thin, bright tomato-chili gravy with ginger, garlic and warm spices, finished with plenty of fresh cilantro. Even better on day two.",
    "servings": 12,
    "yieldNote": "12 portions (about 2 pieces of chicken, 4 to 5 potato chunks and ¾ cup gravy each)",
    "active": 45,
    "total": 110,
    "tags": [
      "High protein",
    ...
    "image": "/cookbook/mp/chicken-and-potato-curry.webp",
    "photoCredit": {
      "author": "Muhammad Khawar Nazir",
      "source": "Pexels",
      "page": "https://www.pexels.com/photo/delicious-homemade-chicken-stew-in-container-38003492/"
    },
    "ingredients": [
      "9 lb bone-in chicken thighs and drumsticks, skin pulled off (about 24 pieces)",
      "1 tbsp kosher salt (for the chicken)",
      "1 tsp ground turmeric (for the chicken)",
      "½ cup neutral oil",
      "2 tsp cumin seeds",
      ...
      "1 tbsp ground coriander",
      "2 tsp ground cumin",
      "2 tsp Kashmiri chili powder or sweet paprika (for color)",
      "1 to 2 tsp cayenne, to taste",
      "1 tsp ground turmeric (for the sauce)",
      "1 can (28 oz) crushed tomatoes",
      "1 tbsp kosher salt (for the sauce), plus more to taste",
    ...
    "directions": [
      "Toss the chicken with the salt and turmeric and set it aside while you chop.",
      "Heat the oil in an 8-quart or larger heavy pot over medium-high heat. Add the cumin seeds and let them sizzle 30 seconds, then add the onions. Cook, stirring often and lowering the heat if they catch, for 15 to 20 minutes, until deep golden brown. The color and body of the gravy come from this step, so don't rush it.",
      "Add the ginger and garlic and cook 1 to 2 minutes, until the raw smell is gone. Stir in the coriander, ground cumin, chili powder, cayenne and turmeric for 30 seconds.",
      "Add the crushed tomatoes and the sauce salt and cook, stirring, 8 to 10 minutes, until the paste darkens and oil starts to pool at the edges.",
      "Add the chicken and turn it in the masala for 8 to 10 minutes, until the outside of every piece is opaque.",
      "Add the potatoes and water and bring to a boil. Partially cover and simmer 30 to 35 minutes, stirring gently now and then, until the potatoes are tender to a knife and the thickest chicken piece reads at least 175°F near the bone. The gravy should stay thin and brothy; add a splash of water if it tightens.",
      "Stir in the garam masala and lemon juice, then taste for salt and heat.",
      "Divide the curry among shallow pans no more than 2 inches deep and cool uncovered, stirring once or twice, until it drops to 70°F within 2 hours. Never cool the full pot.",
      "Pack 2 pieces of chicken, 4 to 5 potato chunks and about ¾ cup gravy into each of 12 leak-proof containers, then top each with a spoonful of chopped cilantro."
    ],
    "equipment": [
      "8-quart or larger heavy pot",
      "Shallow pans for cooling",
      "Instant-read thermometer",
      "12 leak-proof meal-prep containers"
    ],
    "storage": "Cool uncovered in shallow layers so everything drops to 70°F within 2 hours and to 41°F or below within the next 4 hours, then lid and refrigerate at 40°F or colder. Keeps 4 days. Freezes up to 3 months (leave the cilantro off portions going in the freezer; the potatoes turn a little softer after thawing).",
    "reheating": "Microwave: vent the lid and heat 3 to 4 minutes, turning the chicken halfway, until the gravy bubbles and the chicken reaches 165°F. Stovetop: tip into a small covered pan with a splash of water and heat over medium for 8 to 10 minutes.",
    "makeAhead": "",
    "safety": "Cook the chicken to at least 165°F. A big pot of stew is the classic cooling hazard, so always split it into shallow pans before it goes in the fridge. Reheat to 165°F.",
    "chefNotes": "Bone-in pieces give the gravy body and keep the meat moist through reheating. Kashmiri chili gives the red color without much heat; Fred Meyer's international aisle carries it, or use sweet paprika. The cilantro darkens a little by day 4 but keeps its flavor; leave it off for customers who don't like it. Salt amounts assume Diamond Crystal kosher salt; with Morton, use a little over half."
  },
  {
    "id": 33,
    "slug": "paprika-chicken-thighs-with-black-beans-and-sweet-potatoes",
    "side": "meal-prep",
    "title": "Paprika Chicken Thighs with Black Beans and Sweet Potatoes",
    "category": "Poultry",
    "description": "Boneless chicken thighs rubbed with smoked paprika, cumin and garlic and roasted until the edges crisp, with garlicky black beans and roasted skin-on sweet potato wedges.",
    "servings": 12,
    "yieldNote": "12 portions (about 5 oz chicken, ¾ cup black beans and 1 cup sweet potato each)",
    "active": 40,
    "total": 75,
    "tags": [
      "High protein",
    ...
    "image": "/cookbook/mp/paprika-chicken-thighs-with-black-beans-and-sweet-potatoes.webp",
    "photoCredit": {
      "author": "MealPro",
      "source": "Unsplash",
      "page": "https://unsplash.com/photos/pKobPSZr2bw"
    },
    "ingredients": [
      ...
      "2 tsp ground cumin (for the chicken)",
      "2 tsp garlic powder",
      "1 tsp onion powder",
      "1 tsp dried oregano",
      "½ tsp cayenne",
      "1 tbsp kosher salt (for the chicken)",
      "1 tsp black pepper",
      "6 lb sweet potatoes (about 6 large), scrubbed, skin on, each cut lengthwise into 8 wedges",
      "¼ cup olive oil (for the sweet potatoes)",
      "2 tsp kosher salt (for the sweet potatoes)",
    ...
    "directions": [
      "Heat the oven to 425°F with racks in the upper-middle and lower-middle positions and line two rimmed sheet pans with parchment.",
      "Toss the sweet potato wedges with the olive oil and salt and lay them skin side down on the lined pans. Roast 30 to 35 minutes, rotating the pans halfway, until tender and browned at the edges. Move them to a cooling rack.",
      "Stir the paprikas, cumin, garlic powder, onion powder, oregano, cayenne, salt and pepper together. Pat the chicken dry, toss it with the olive oil, then with the spice mix, using tongs or a spoon so your hands don't go back into the spice bowl.",
      "Lay the thighs flat and opened out on two oiled, foil-lined sheet pans. Roast at 425°F for 20 to 25 minutes, rotating the pans halfway, until the thickest piece reads 175°F. Then broil one pan at a time for 1 to 2 minutes to crisp the edges, standing right there: smoked paprika scorches fast.",
      "Meanwhile, warm the olive oil in a medium saucepan over medium heat. Add the garlic and cumin for 1 minute, then the beans, water and salt. Simmer 10 minutes, mashing a few beans against the side so the liquid turns creamy, and stir in the lime juice.",
      "Cool the chicken, beans and sweet potatoes uncovered in shallow layers until they drop to 70°F, within 2 hours.",
      "Spoon ¾ cup beans along one side of each of 12 containers, lay about 5 oz chicken over them and tuck the sweet potato wedges alongside. Finish each with a couple of parsley leaves."
    ],
    "equipment": [
      "4 rimmed sheet pans",
    ...
    "storage": "Cool uncovered in shallow layers so everything drops to 70°F within 2 hours and to 41°F or below within the next 4 hours, then lid and refrigerate at 40°F or colder. Keeps 4 days. Freezes up to 3 months; the sweet potatoes turn softer after thawing.",
    "reheating": "Microwave: vent the lid and heat at 70% power for 2½ to 3½ minutes, turning the chicken over halfway, until it reaches 165°F. Oven: cover with foil and heat at 350°F for 15 to 20 minutes.",
    "makeAhead": "",
    "safety": "Cook the chicken to at least 165°F and throw out any rub that touched raw meat. Rinse canned beans. Reheat to 165°F.",
    "chefNotes": "Thighs instead of breast so the chicken stays tender after reheating. The garnish in the photo is flat-leaf parsley. Buy boneless thighs in the Costco multi-pack and the sweet potatoes by the bag. Salt amounts assume Diamond Crystal kosher salt; with Morton, use a little over half."
  },
  {
    "id": 34,
    "slug": "wild-rice-sweet-potato-and-white-bean-bowls-with-basil-dressing",
    "side": "meal-prep",
    "title": "Wild Rice, Sweet Potato and White Bean Bowls with Basil Dressing",
    "category": "Vegetarian",
    "description": "A wild rice blend with caramelized roasted sweet potato, tender massaged kale, cannellini beans and sliced tomatoes, sprinkled with toasted pine nuts, with a bright basil-lemon dressing on the side. Good warm or cold.",
    "servings": 12,
    "yieldNote": "12 portions (about ¾ cup rice, 1 cup sweet potato, ½ cup beans, ¾ cup kale, 1 sliced tomato and 2 tbsp dressing each)",
    "active": 50,
    "total": 80,
    "tags": [
      "Vegan",
    ...
    "image": "/cookbook/mp/wild-rice-sweet-potato-and-white-bean-bowls-with-basil-dressing.webp",
    "photoCredit": {
      "author": "Leanna Myers",
      "source": "Unsplash",
      "page": "https://unsplash.com/photos/a-group-of-trays-with-food-O9yqcq3QHSM"
    },
    "ingredients": [
      "3 cups wild rice blend (long-grain white and wild rice, such as Lundberg)",
      "6 cups water (or as the rice package directs)",
      "1½ tsp kosher salt (for the rice)",
      "6 lb sweet potatoes, peeled and cut into ¾-inch cubes",
      "¼ cup olive oil (for the sweet potatoes)",
      "2 tsp kosher salt (for the sweet potatoes)",
      "½ tsp black pepper",
      "1½ lb curly kale (about 2 large bunches), stems removed, torn into bite-size pieces",
      "1 tbsp olive oil (for the kale)",
      "1 tbsp fresh lemon juice (for the kale)",
      "¼ tsp kosher salt (for the kale)",
      "4 cans (15 oz each) cannellini beans, drained and rinsed",
      "12 small vine tomatoes (Campari size), sliced ¼ inch thick on packing day",
      "¾ cup pine nuts",
      "3 packed cups fresh basil leaves (for the dressing)",
      "½ cup fresh parsley leaves (for the dressing)",
      "⅔ cup olive oil (for the dressing)",
      "⅓ cup fresh lemon juice (for the dressing, about 2 lemons)",
    ...
    "directions": [
      "Heat the oven to 425°F with racks in the upper-middle and lower-middle positions. Toss the sweet potatoes with the olive oil, salt and pepper and spread them on two rimmed sheet pans without crowding. Roast 30 to 35 minutes, flipping and rotating halfway, until the edges are deeply browned.",
      "Rinse the rice blend and cook it in salted water as the package directs (blends with wild rice usually simmer covered 45 to 50 minutes). Rest 10 minutes off the heat, fluff, and spread on a sheet pan to cool.",
      "Toast the pine nuts in a dry skillet over medium-low heat, shaking often, 3 to 5 minutes, until golden. Tip them onto a plate right away; they burn fast.",
      "Massage the kale with the oil, lemon juice and salt for 2 to 3 minutes, until it darkens and turns tender.",
      "Blend all the dressing ingredients until smooth and creamy. Taste for salt and lemon.",
      "Cool the rice and sweet potatoes until they drop to 70°F, within 2 hours.",
      "In each of 12 containers, lay rice across one end, then sweet potatoes, a bed of kale topped with 3 or 4 tomato slices, and beans at the other end. Scatter pine nuts over the top. Pour 2 tbsp dressing into a lidded cup for each container."
    ],
    "equipment": [
      "2 rimmed sheet pans",
      "Medium pot with lid",
      "Skillet",
      "Blender",
      "12 meal-prep containers with 2-oz dressing cups"
    ],
    "storage": "Cool uncovered in shallow layers so everything drops to 70°F within 2 hours and to 41°F or below within the next 4 hours, then lid and refrigerate at 40°F or colder. Keeps 4 days. Don't freeze: the kale and tomatoes turn watery.",
    "reheating": "Good cold or warm. To eat it warm, lift out the tomato slices and the dressing cup, vent the lid and microwave 1½ to 2 minutes until the rice and sweet potato are steaming, then put the tomatoes back and add the dressing.",
    "makeAhead": "",
    "safety": "Cooked rice needs to cool quickly: spread it thin so it drops to 70°F within 2 hours, then refrigerate at 40°F or below. If eating it warm, reheat until steaming (165°F). Pine nuts are labeled as a tree nut allergen. Wash the kale and tomatoes well since they are eaten without further cooking.",
    "chefNotes": "The one bowl on the menu that is just as good straight from the fridge, which makes it a strong lunch pick. Pine nuts are the pricey item; buy them at Costco and keep them in the freezer. Slice the tomatoes on packing day so they don't weep into the rice."
  },
  {
    "id": 35,
    "slug": "baked-falafel-bowls-with-herbed-rice-and-roasted-vegetables",
    "side": "meal-prep",
    ...
    "image": "/cookbook/mp/baked-falafel-bowls-with-herbed-rice-and-roasted-vegetables.webp",
    "photoCredit": {
      "author": "Ella Olsson",
      "source": "Pexels",
