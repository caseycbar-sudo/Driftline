...
export type StaffProfile={email:string;fullName:string;role:StaffRole;status:"active"|"invited"|"suspended";phone:string;jobTitle:string;hireDate:string;emergencyContact:string;foodHandlerExpires:string;foodManagerExpires:string;adminNotes:string;createdAt:string;updatedAt:string};
